...
public record CustomBossBar(BossBarManager.Type type, String name, List<Float> phases, List<BossBarEvent> events,
    ...
    public CustomBossBar withName(String name) {
        return new CustomBossBar(type, name, phases, events, textures, textureFrames, overlays, overlayFrames, width, height, left, right);
    }
}
